...
Write-Host "   1) MySQL：创建库 nscp_dev（或与 application.properties 中 URL 一致），并执行："
Write-Host "      stage1_init.sql 再 stage2_init.sql（合并入口）；或按 db\00_install_order.txt 执行 schema/ 与 seed/ 拆分脚本。"
